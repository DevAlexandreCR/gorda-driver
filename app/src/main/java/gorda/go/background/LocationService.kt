...
import gorda.go.R
import gorda.go.activity.StartActivity
import gorda.go.interfaces.LocInterface
import gorda.go.location.LocationHandler
import gorda.go.models.Driver
import gorda.go.repositories.DriverRepository
import gorda.go.repositories.ServiceRepository
import gorda.go.ui.service.LocationBroadcastReceiver
import gorda.go.ui.service.ServiceEventListener
import gorda.go.ui.service.ServicesEventListener
import gorda.go.utils.Constants
import gorda.go.utils.Constants.Companion.LOCATION_EXTRA
import gorda.go.utils.Utils
import java.util.Locale
import java.util.Timer
import java.util.TimerTask
import gorda.go.models.Service as DBService
...
class LocationService : Service(), TextToSpeech.OnInitListener, LocationListener {
    ...
    private var nextService: gorda.go.models.Service? = null
