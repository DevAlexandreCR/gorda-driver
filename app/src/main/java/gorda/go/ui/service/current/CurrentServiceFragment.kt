package gorda.go.ui.service.current
...
import gorda.go.R
import gorda.go.background.FeesService
import gorda.go.databinding.FragmentCurrentServiceBinding
import gorda.go.interfaces.RideFees
import gorda.go.interfaces.ServiceMetadata
import gorda.go.maps.Map
import gorda.go.models.Service
import gorda.go.ui.MainViewModel
import gorda.go.ui.history.ServiceDialogFragment
import gorda.go.ui.home.HomeFragment
import gorda.go.ui.service.ConnectionServiceDialog
import gorda.go.utils.Constants
import gorda.go.utils.NumberHelper
import gorda.go.utils.ServiceHelper
